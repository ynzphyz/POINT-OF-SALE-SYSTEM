...
export const tables: Table[] = [
  ...
  },
  {
    ...
    seatedAt: new Date("2026-02-27T10:30:00"),
  },
  {
    id: "t3",
    name: "A3",
  ...
  },
  {
    ...
    rotation: 0,
    reservationId: "res1",
    customerName: "Bella Safira",
  },
  
  // Ruang Dalam - Section B
  {
    id: "t5",
    name: "B1",
    number: "5",
  ...
  },
  {
    ...
    seatedAt: new Date("2026-02-27T11:15:00"),
  },
...
export const floorElements: FloorElement[] = [
  // Cashier station in Ruang Dalam
  {
    id: "elem1",
    type: "cashier",
    position: { x: 5, y: 5 },
  ...
  // Wall divider in Ruang Dalam
  {
    id: "elem2",
    type: "wall",
    position: { x: 40, y: 45 },
    size: { width: 4, height: 150 },
    rotation: 0,
    floor: "Ruang Dalam",
  },
  // Plant decoration in Teras
  {
    id: "elem3",
    type: "plant",
    position: { x: 10, y: 15 },
